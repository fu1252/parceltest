...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/setButton.js":[function(require,module,exports) {
"use strict";
...
function setButton(arr) {
  ...
  try {
    for (var _iterator = arr[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      var i = _step.value;
      btnHtml += "\n\t\t\t<button class=\"btn\" type=\"button\">".concat(i, "</button>\n\t\t");
    }
  } catch (err) {
...
},{}],"js/setColor.js":[function(require,module,exports) {
...
var setButton = require('./setButton').setButton;

var setColor = require('./setColor').setColor;
...
},{"./setButton":"js/setButton.js","./setColor":"js/setColor.js"}],"../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
